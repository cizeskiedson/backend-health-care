...
exports.BackendHealthCareApplication = void 0;
...
class BackendHealthCareApplication extends (0, boot_1.BootMixin)((0, service_proxy_1.ServiceMixin)((0, repository_1.RepositoryMixin)(rest_1.RestApplication))) {
    constructor(options = {}) {
        super(options);
...
exports.BackendHealthCareApplication = BackendHealthCareApplication;
