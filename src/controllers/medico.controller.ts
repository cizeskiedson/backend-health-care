...
export class MedicoController {
  ...
  async count(@param.where(Medico) where?: Where<Medico>): Promise<Count> {
  ...
  async find(@param.filter(Medico) filter?: Filter<Medico>): Promise<Medico[]> {
  ...
  async findById(
    ...
    @param.filter(Medico, {exclude: 'where'})
    filter?: FilterExcludingWhere<Medico>,
  ): Promise<Medico> {
