...
declare const BackendHealthCareApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class BackendHealthCareApplication extends BackendHealthCareApplication_base {
